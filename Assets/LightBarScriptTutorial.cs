...
public class LightBarScriptTutorial : MonoBehaviour
{
    public bool freeze;
    bool setup = false;
    bool entered = false;
    PlayerScriptTutorial pScript;
    LogicScriptTutorial lScript;
    ...
    {
        // freeze = true; //remove
        pScript = FindObjectOfType<PlayerScriptTutorial>();
        lScript = FindObjectOfType<LogicScriptTutorial>();
